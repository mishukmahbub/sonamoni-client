...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-base-200 text-base-content">
            <div>
                <img src="/src/assets/toys.svg" className='w-10' />
                <p className="font-bold">
                    Sonamoni Ltd.
                </p>
                <p><span className='font-semibold'>Address:</span> Some st, NY, USA</p>
                <p><span className='font-semibold'>Phone:</span> +0123456789</p>
            </div>
            <div>
